...
Все компоненты регистрируются в DI-контейнере при старте через . ViewModel-ы регистрируются как `Transient`, сервисы навигации и состояния — как `Singleton`.
